...
A curated list of PICO-8 resources, tutorials, tools and more. Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 508,375 | 🐛 106 | 📅 2026-09-02 list thing. You might also like [awesome-lua](https://github.com/LewisJEllis/awesome-lua) ⭐ 4,575 | 🐛 50 | 📅 2024-08-11 and [awesome-love2d](https://github.com/JanWerder/awesome-love2d) ⭐ 4,504 | 🐛 0 | 🌐 PowerShell | 📅 2026-08-23.
...
* [picotool](https://github.com/dansanderson/picotool) ⭐ 408 | 🐛 55 | 🌐 Python | 📅 2024-02-03 -  Tools and Python libraries for manipulating Pico-8 game files.
...
* [P8Coder](https://github.com/movAX13h/P8Coder) ⭐ 112 | 🐛 3 | 🌐 C# | 📅 2025-07-22 - A programming tool that replaces the lua code in pico-8 cartridges (p8) with the code you write in P8Coder.
...
* [SCUMM-8](https://github.com/Liquidream/scumm-8) ⭐ 362 | 🐛 2 | 🌐 Lua | 📅 2025-08-11 - De-make of the SCUMM engine for making point-and-click classic adventures.
...
* [pico-test](https://github.com/jozanza/pico-test) ⭐ 47 | 🐛 2 | 🌐 JavaScript | 📅 2023-03-19 - PICO-8 testing framework.
...
* Visual Studio Code: [pico8-ls](https://github.com/japhib/pico8-ls) ⭐ 112 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-14 - PICO-8 Language Server, providing full language support for the PICO-8 dialect of Lua.
...
* [PicoLove](https://github.com/picolove/picolove) ⭐ 890 | 🐛 17 | 🌐 Lua | 📅 2024-10-24 - Pico-8 Reimplementation in LÖVE.
